...
export function Scene3() {
  ...
  return (
    <motion.div
      className="absolute inset-0 flex items-center justify-center bg-black overflow-hidden z-50"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <motion.div
        className="absolute -bottom-[30vh] w-[150vw] h-[50vh] bg-brand-blue/30 blur-[100px] rounded-[100%]"
      ...
      <div className="relative z-10 w-full px-8 text-center">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-black text-white leading-relaxed tracking-tight">
            قررنا نغيّر الطريقة.
          </h2>
        </motion.div>
        ...
        <motion.div
          className="h-1 bg-gradient-to-r from-transparent via-brand-cyan to-transparent mx-auto mt-6"

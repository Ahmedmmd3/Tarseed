  ...
  return (
    <div className="flex flex-col gap-6" data-testid="page-inventory">
      ...
      <Tabs defaultValue="products" className="w-full">
        ...
        <TabsContent value="products"><CrudTable table="products" title="إدارة المنتجات" fields={[{ key: 'name', label: 'الاسم', required: true }, { key: 'barcode', label: 'الباركود' }, { key: 'sku', label: 'رمز المنتج' }, { key: 'price', label: 'سعر البيع', type: 'number' }, { key: 'cost', label: 'سعر التكلفة', type: 'number' }]} /></TabsContent>

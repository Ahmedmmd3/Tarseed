...
export const organizationsTable = pgTable("organizations", {
  ...
  initializationStatus: text("initialization_status").notNull().default("ready"),
  initializationFailureCode: text("initialization_failure_code"),
  ...
  fiscalYearClosed: boolean("fiscal_year_closed").notNull().default(false),
